package ai.shreds.domain; 
  ...
  */ 
 class DomainProductValidationException extends DomainProductBaseException { 
 ...
 /** 
  * Exception thrown for general domain errors. 
  */ 
 class DomainProductDomainException extends DomainProductBaseException { 
 ...
 /** 
  * Base exception class for domain product exceptions. 
  */ 
 abstract class DomainProductBaseException extends RuntimeException { 
