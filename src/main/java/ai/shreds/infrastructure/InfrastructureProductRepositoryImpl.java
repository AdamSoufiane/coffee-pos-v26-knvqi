package ai.shreds.infrastructure; 
 ...
 // Implementation Note: Use Lombok annotations for getters and setters in DomainProductEntity. 
 // Description: This class extends JpaRepository and implements DomainProductRepositoryPort. 
