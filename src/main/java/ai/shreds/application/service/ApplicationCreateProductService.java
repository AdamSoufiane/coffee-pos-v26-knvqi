package ai.shreds.application.service;
...
public class ApplicationCreateProductService implements ApplicationCreateProductInputPort {
    ...
    @Autowired
    public ApplicationCreateProductService(@NotNull DomainProductServicePort domainService) {
        this.domainService = domainService;
    }

    @Override
    public SharedProductResponseDTO createProduct(@Valid @NotNull SharedCreateProductRequestParams requestParams) {
    ...
    private void validateRequestParams(@NotNull SharedCreateProductRequestParams requestParams) {
